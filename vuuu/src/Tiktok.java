...
public class Tiktok extends javax.swing.JFrame {
  ...
  //PrintButtonMap for Diagnostics
        void printbuttonMap(Integer[][] bMap) {
            ...
            for (int i = 0; i  {
                for (int j = 0; j System.out.print(bMap[i][j] + " ");
            }
...
try {
            ...
            java.util.logging.Logger.getLogger(Tiktok.class  
